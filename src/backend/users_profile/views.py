...
from users_playlist.models import Playlist
...
@view_bp.route('/')
def index():
    playlists = Playlist.find_random_playlists() 
    return render_template('index.html', user=session.get('username'), playlists=playlists)
